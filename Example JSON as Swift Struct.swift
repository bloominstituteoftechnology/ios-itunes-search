...
struct Result: Codable {
    ...
    let primaryGenreName, minimumOSVersion: String
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case artworkUrl60, artworkUrl100, ipadScreenshotUrls, appletvScreenshotUrls, screenshotUrls, artworkUrl512, isGameCenterEnabled, supportedDevices, kind, features, advisories, contentAdvisoryRating, trackCensoredName
        case trackViewURL = "trackViewUrl"
        case averageUserRatingForCurrentVersion, languageCodesISO2A, fileSizeBytes
        case sellerURL = "sellerUrl"
        case userRatingCountForCurrentVersion, trackContentRating, currentVersionReleaseDate, releaseNotes, formattedPrice
        case genreIDS = "genreIds"
        case sellerName
        case trackID = "trackId"
        case trackName, releaseDate, primaryGenreName
        case minimumOSVersion = "minimumOsVersion"
        case currency, wrapperType, version, description
        case artistID = "artistId"
        case artistName, genres, price
        case bundleID = "bundleId"
        case primaryGenreID = "primaryGenreId"
        case isVppDeviceBasedLicensingEnabled, averageUserRating, userRatingCount
    }
}
